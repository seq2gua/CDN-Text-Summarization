...
class Seq2SeqModel(object):
    ...
    def build_placeholder(self):
        ...
        self.encoder_bert = tf.placeholder(tf.float32, [None, None, 768], name='encoder_bert')
    ...
    def build_encoder(self):
        ...
        with tf.variable_scope('encoder'):
            ...
            encoder_bert_embedded = self.encoder_bert
            concat_embedded = tf.concat([encoder_inputs_embedded, encoder_bert_embedded], 2)
            print("concat_embedded: " + str(concat_embedded.get_shape().as_list()))
            # 构建动态双向多层RNN
    ...
    def train(self, batch):
        feed_dict = {self.encoder_inputs: batch.encoder_inputs,
                     ...
                     self.keep_prob: 0.5,
                     self.encoder_bert: batch.encoder_bert,
